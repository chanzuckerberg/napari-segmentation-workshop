...
If you've arrived on this Jupyter Book, that means you likely have an interest in **cell biology, imaging analysis**, and all the applications of the [**open-source napari platform**](https://www.napari.org)! By following this course, you’ll learn 1) how to install napari successfully, and 2) all the fundamentals to performing cell segmentation in napari on your own data. Although napari currently requires *some* Python and command prompt/terminal experience, we try to keep it to *a minimum* in all our lessons. 
