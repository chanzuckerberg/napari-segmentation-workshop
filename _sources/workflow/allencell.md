...
The above video demonstrates how to complete the [Allen Cell segmentation workflow](allencell-protocol.md) within the napari viewer, and showcases how the adjusting of parameters affects the resulting segmentation.
