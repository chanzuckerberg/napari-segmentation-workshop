...
:::{hint}
Before proceeding, ensure that the Built-in reader plugin is being used, to minimize errors. You can verify this by going to menu **File >> Preference >> Plugins**, then checking that **"Built-in reader plugin"** is enabled. 
:::
