...
The above video demonstrates how you open the *Cellpose-napari* plugin, adjust parameters, and segment your image. If you would like to an even deeper [explanation of each parameter](cellpose-parameters.md), proceed to the next part of this lesson. 
  
:::{note}
Because napari cannot export an image's mask at this time, we must perform this task in FIJI. The [last part of this lesson](cellpose-FIJI.md) covers how you segment your image in napari, then use FIJI to refine, export and analyze your image's mask. 
:::
