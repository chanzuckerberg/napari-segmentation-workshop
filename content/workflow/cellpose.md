...
The above video demonstrates how to open the *Cellpose-napari* plugin, adjust parameters, and finally segment your image. If you would like to an even deeper [explanation of each parameter](cellpose-parameters.md), proceed to the next part of this lesson. 
